"""
Django settings for ravitest_88 project.
...
WSGI_APPLICATION = 'ravitest_88.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravitest_88 API",
    "DESCRIPTION": "API documentation for ravitest_88 App",
    "VERSION": "v1",
}
